...
export class PopupMessage extends Component {
  ...
  render() {
    ...
    return (
      <div style={{position: 'fixed', top: '5px', height: '30px', marginTop: '20px', minWidth: '80px', maxWidth: '380px', left: '52%',  transform: 'translate(-50%, -50%)'
        ,zIndex: '1112'}}>
     
 
      <Alert severity={severity} >{this.props.messageTitle}</Alert>
    
      <Snackbar style={{top: "0", height: "0px",  display:'none'}}
        open={this.state.open}
         autoHideDuration={this.props.time===undefined?5000:this.props.time}         
