      ...
      <div>
        ...
        >
          ...
          <DialogContent>
            ...
            {this.props.formMessage !== undefined && (
              <form>
                <TextField
                  id="1"
          ...
          <DialogActions
            style={{ paddingRight: "12px", paddingBottom: "10px" }}
          >
            {infoIcon !== undefined && (
              <span style={{ height: "50px", marginLeft: "10px" }}>
                <Info infoIcon={infoIcon} />
              </span>
            )}
            <br />
            {/* <Button onClick={this.handleInfo} variant="contained"> <span className="dialog"> Instructions </span></Button> */}
            {(this.props.OKOnly === undefined ||
              this.props.OKOnly === false) && (
              <Button
                onClick={this.handleCancel}
                variant="contained"
                style={{
                  marginLeft: this.props.language === "en" ? "222px" : "340px",
                  marginRight: "8px",
                }}
              >
                {" "}
                <span className="dialog">
                  {" "}
                  {this.props.language === "en" ? "Cancel" : "Annuler"}{" "}
                </span>
              </Button>
            )}
